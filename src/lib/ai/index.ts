...
export { cropDiseaseAI, CropDiseaseDetectionService } from './cropDiseaseDetection';
...
export { resourceOptimizationAI, ResourceOptimizationAI } from './resourceOptimizationAI';
export type {
